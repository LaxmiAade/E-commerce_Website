  ...
  return (
    <div className='Foot'>
        ...
        <div id="box1"  className='footdiv'>
            <a href="tel:+919373382180"><i class="fa-solid fa-phone">Call</i></a>
            <a href="mailto:laxmiaade8605@gmail.com"><i class="fa-solid fa-mail-bulk">Mail</i></a>
            <a href="whatsapp"> <i class="fa-brands fa-whatsapp">Watsapp</i></a>
        </div>
